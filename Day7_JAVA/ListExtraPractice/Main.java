...
public class Main {
    public static void main(String[] args) {
        ...
        store.addNewBook(book1);
        store.addNewBook(book2);
        ...
        System.out.println(store.containss(book2)); // should be true before selling the book
    
        // Test the sellBook method
        store.sellBook("1984");
        System.out.println(store.containss(book2)); // should be false now
    }
}
